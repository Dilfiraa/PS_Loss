...
python -u run.py \
  ...
  --itr 1 >logs/${loss_name}/ETTm1_96_96_${ps_lambda}lambda.log
...
python -u run.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/ETTm1_96_192_${ps_lambda}lambda.log
...
python -u run.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/ETTm1_96_336_${ps_lambda}lambda.log
...
python -u run.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/ETTm1_96_720_${ps_lambda}lambda.log
