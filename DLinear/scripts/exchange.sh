...
python -u run_longExp.py \
  ...
  --itr 1 >logs/${loss_name}/Exchange_336_96_${ps_lambda}lambda.log
...
python -u run_longExp.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/Exchange_336_192_${ps_lambda}lambda.log
done



if [ "$use_ps_loss" -eq 1 ]; then
...
python -u run_longExp.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/Exchange_336_336_${ps_lambda}lambda.log
...
python -u run_longExp.py \
  ...
  --ps_lambda $ps_lambda\
  --patch_len_threshold $patch_len_threshold\
  --itr 1 >logs/${loss_name}/Exchange_336_720_${ps_lambda}lambda.log
